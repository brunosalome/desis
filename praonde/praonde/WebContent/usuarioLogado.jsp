<%@ page import="java.util.*, Dao.*, Servlets.*" %>
	     	<%
	     	System.out.println("TESTE DE LOGADO");
...
<!-- header -->
		<header>
			...
			<div class="wrapper">
				...
				<nav> 
					<ul id="menu">
					 	<li id="menu_active" ><a href="#"><span><span>Painel</span></span></a></li>
						<li class="nav2"><a href="adiciona_veiculo.jsp?idUsuario=<%=idUsuario%>"><span><span> Cadastrar veículo</span></span></a></li>
						<li class="nav3"><a href="oferece_carona.jsp"><span><span>Oferecer Carona</span></span></a></li>
			...
			<div class="wrapper">
				...
				<div class="text">
					<p>Seja bem vindo, <%=usuario.getNome()%> !<span></span></p>
					<br/><br/><br/>
					<p>Clique <a href="exibe_veiculo.jsp?idUsuario=<%=usuario.getIdUsuario()%>&idVeiculo=0"> aqui </a> para ver seus veiculos cadastrados!<span></span></p>
				</div>
			</div>
			...
			<section class="col1">
				...
				<form id="newsletter">
					<div>
						...
						<a href="#" class="button" onclick="document.getElementById('ContactForm').submit()">Inscrever</a>
					</div>
				</form>
        	</section>
			<section class="col_1">
